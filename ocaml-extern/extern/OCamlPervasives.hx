typedef PervasivesNonrec fpclass  = Dynamic;

typedef PervasivesNonrec in_channel  = Dynamic;

typedef PervasivesNonrec out_channel  = Dynamic;

typedef PervasivesNonrec open_flag  = Dynamic;
...
public static var stdin:OCamlStdlib.StdlibIn_channel;
public static var stdout:OCamlStdlib.StdlibOut_channel;
public static var stderr:OCamlStdlib.StdlibOut_channel;
...
public static function open_out(a0:String):OCamlStdlib.StdlibOut_channel;
public static function open_out_bin(a0:String):OCamlStdlib.StdlibOut_channel;
public static var open_out_gen:Dynamic;
public static function flush(a0:OCamlStdlib.StdlibOut_channel):Void;
public static function flush_all(a0:Void):Void;
public static function output_char(a0:OCamlStdlib.StdlibOut_channel,a1:OCamlChar):Void;
public static function output_string(a0:OCamlStdlib.StdlibOut_channel,a1:String):Void;
public static function output_bytes(a0:OCamlStdlib.StdlibOut_channel,a1:haxe.io.Bytes):Void;
public static function output(a0:OCamlStdlib.StdlibOut_channel,a1:haxe.io.Bytes,a2:Int,a3:Int):Void;
public static function output_substring(a0:OCamlStdlib.StdlibOut_channel,a1:String,a2:Int,a3:Int):Void;
public static function output_byte(a0:OCamlStdlib.StdlibOut_channel,a1:Int):Void;
public static function output_binary_int(a0:OCamlStdlib.StdlibOut_channel,a1:Int):Void;
public static function output_value(a0:OCamlStdlib.StdlibOut_channel,a1:Dynamic):Void;
public static function seek_out(a0:OCamlStdlib.StdlibOut_channel,a1:Int):Void;
public static function pos_out(a0:OCamlStdlib.StdlibOut_channel):Int;
public static function out_channel_length(a0:OCamlStdlib.StdlibOut_channel):Int;
public static function close_out(a0:OCamlStdlib.StdlibOut_channel):Void;
public static function close_out_noerr(a0:OCamlStdlib.StdlibOut_channel):Void;
public static function set_binary_mode_out(a0:OCamlStdlib.StdlibOut_channel,a1:Bool):Void;
public static function open_in(a0:String):OCamlStdlib.StdlibIn_channel;
public static function open_in_bin(a0:String):OCamlStdlib.StdlibIn_channel;
public static function open_in_gen(a0:OCamlStdlib.StdlibOpen_flaglist,a1:Int,a2:String):OCamlStdlib.StdlibIn_channel;
public static function input_char(a0:OCamlStdlib.StdlibIn_channel):OCamlChar;
public static function input_line(a0:OCamlStdlib.StdlibIn_channel):String;
public static function input(a0:OCamlStdlib.StdlibIn_channel,a1:haxe.io.Bytes,a2:Int,a3:Int):Int;
public static function really_input(a0:OCamlStdlib.StdlibIn_channel,a1:haxe.io.Bytes,a2:Int,a3:Int):Void;
public static function really_input_string(a0:OCamlStdlib.StdlibIn_channel,a1:Int):String;
public static function input_byte(a0:OCamlStdlib.StdlibIn_channel):Int;
public static function input_binary_int(a0:OCamlStdlib.StdlibIn_channel):Int;
public static function input_value(a0:OCamlStdlib.StdlibIn_channel):Dynamic;
public static function seek_in(a0:OCamlStdlib.StdlibIn_channel,a1:Int):Void;
public static function pos_in(a0:OCamlStdlib.StdlibIn_channel):Int;
public static function in_channel_length(a0:OCamlStdlib.StdlibIn_channel):Int;
public static function close_in(a0:OCamlStdlib.StdlibIn_channel):Void;
public static function close_in_noerr(a0:OCamlStdlib.StdlibIn_channel):Void;
public static function set_binary_mode_in(a0:OCamlStdlib.StdlibIn_channel,a1:Bool):Void;
...
public static function string_of_format(a0:OCamlfunStdlib.funStdlibFormat6):String;
