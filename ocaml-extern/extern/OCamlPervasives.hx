typedef Pervasives_Nonrec fpclass  = Dynamic;

typedef Pervasives_Nonrec in_channel  = Dynamic;

typedef Pervasives_Nonrec out_channel  = Dynamic;

typedef Pervasives_Nonrec open_flag  = Dynamic;
