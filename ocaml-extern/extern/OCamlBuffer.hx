...
public static function add_utf_8_uchar(a0:Dynamic,a1:Dynamic):Void;
public static function add_utf_16be_uchar(a0:Dynamic,a1:Dynamic):Void;
public static function add_utf_16le_uchar(a0:Dynamic,a1:Dynamic):Void;
...
public static function unsafe_set_int(a0:haxe.io.Bytes,a1:Int,a2:Int):Void;
public static function unsafe_set_int(a0:haxe.io.Bytes,a1:Int,a2:Int):Void;
public static function unsafe_set_int(a0:haxe.io.Bytes,a1:Int,a2:Dynamic):Void;
public static function unsafe_set_int(a0:haxe.io.Bytes,a1:Int,a2:Dynamic):Void;
