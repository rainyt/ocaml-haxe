...
public static function to_bytes(a0:Buffer_T):haxe.io.Bytes;
public static function sub(a0:Buffer_T,a1:Int,a2:Int):String;
public static function blit(a0:Buffer_T,a1:Int,a2:haxe.io.Bytes,a3:Int,a4:Int):Void;
public static function nth(a0:Buffer_T,a1:Int):OCamlChar;
...
public static function resize(a0:Buffer_T,a1:Int):Void;
public static function add_char(a0:Buffer_T,a1:OCamlChar):Void;
...
public static function add_subbytes(a0:Buffer_T,a1:haxe.io.Bytes,a2:Int,a3:Int):Void;
public static function add_string(a0:Buffer_T,a1:String):Void;
public static function add_bytes(a0:Buffer_T,a1:haxe.io.Bytes):Void;
...
public static function unsafe_add_channel_up_to(a0:Buffer_T,a1:Dynamic,a2:Int):Int;
...
public static function add_int64_le(a0:Buffer_T,a1:Dynamic):Void;
