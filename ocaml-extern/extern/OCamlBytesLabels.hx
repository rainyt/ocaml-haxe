typedef BytesLabels_T  = haxe.io.Bytes;
...
public static function iter(a0:OCamlChar->Void,a1:haxe.io.Bytes):Void;
public static function iteri(a0:Int->OCamlChar->Void,a1:haxe.io.Bytes):Void;
