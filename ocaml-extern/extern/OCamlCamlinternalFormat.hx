typedef CamlinternalFormatMutable_char_set  = haxe.io.Bytes;

typedef CamlinternalFormatFmtty_ebb  = Dynamic;

typedef CamlinternalFormatPadding_ebb  = Dynamic;

typedef CamlinternalFormatPrecision_ebb  = Dynamic;

typedef CamlinternalFormatBuffer = {
ind :Int,
bytes :haxe.io.Bytes,
}
...
public static function pad_of_pad_opt(a0:Dynamic):OCamlfunCamlinternalFormatBasics.funCamlinternalFormatBasicsPadding;
...
public static function char_of_iconv(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):OCamlChar;
public static var char_of_fconv:Dynamic;
public static function char_of_counter(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsCounter):OCamlChar;
public static function bprint_char_set(a0:Dynamic,a1:String):Void;
public static function bprint_padty(a0:Dynamic,a1:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsPadty):Void;
...
public static function bprint_iconv_flag(a0:Dynamic,a1:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):Void;
...
public static function fix_padding(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsPadty,a1:Int,a2:String):String;
...
public static function format_of_iconv(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):String;
public static function format_of_iconvL(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):String;
public static function format_of_iconvl(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):String;
public static function format_of_iconvn(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv):String;
public static var format_of_fconv:Dynamic;
public static function transform_int_alt(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv,a1:String):String;
public static function convert_int(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv,a1:Int):String;
public static function convert_int32(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv,a1:Dynamic):String;
public static var convert_nativeint:Dynamic;
public static function convert_int64(a0:OCamlCamlinternalFormatBasics.CamlinternalFormatBasicsInt_conv,a1:Dynamic):String;
...
public static function bufput_acc(a0:OCamlBuffer.BufferT,a1:Dynamic):Void;
public static function strput_acc(a0:OCamlBuffer.BufferT,a1:Dynamic):Void;
