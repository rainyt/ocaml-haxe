typedef CamlinternalFormat_Mutable_char_set  = haxe.io.Bytes;

typedef CamlinternalFormat_Fmtty_ebb  = Dynamic;

typedef CamlinternalFormat_Padding_ebb  = Dynamic;

typedef CamlinternalFormat_Precision_ebb  = Dynamic;

typedef CamlinternalFormat_Buffer = {
ind :Int,
bytes :haxe.io.Bytes,
}
