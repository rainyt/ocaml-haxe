package ocaml;
enum OCamlArrayTools_Array {

}

@:native("Array")
extern class OCamlArrayTools{
...
public static function init (a0:Int,a1:Dynamic,a2:Dynamic):Dynamic;
...
public static function iter (a0:Dynamic,a1:Dynamic,a2:Dynamic):Void;
// Parser val::val iteri : (int -> 'a -> unit) -> 'a array -> unit
public static function iteri (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val map : ('a -> 'b) -> 'a array -> 'b array
public static function map (a0:Dynamic,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val mapi : (int -> 'a -> 'b) -> 'a array -> 'b array
public static function mapi (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic):Dynamic;
// Parser val::val fold_left : ('a -> 'b -> 'a) -> 'a -> 'b array -> 'a
public static function fold_left (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Dynamic;
// Parser val::val fold_right : ('b -> 'a -> 'a) -> 'b array -> 'a -> 'a
public static function fold_right (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Dynamic;
// Parser val::val iter2 : ('a -> 'b -> unit) -> 'a array -> 'b array -> unit
public static function iter2 (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Void;
// Parser val::val map2 : ('a -> 'b -> 'c) -> 'a array -> 'b array -> 'c array
public static function map2 (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Dynamic;
// Parser val::val for_all : ('a -> bool) -> 'a array -> bool
public static function for_all (a0:Dynamic,a1:Dynamic,a2:Dynamic):Bool;
// Parser val::val exists : ('a -> bool) -> 'a array -> bool
public static function exists (a0:Dynamic,a1:Dynamic,a2:Dynamic):Bool;
// Parser val::val for_all2 : ('a -> 'b -> bool) -> 'a array -> 'b array -> bool
public static function for_all2 (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Bool;
// Parser val::val exists2 : ('a -> 'b -> bool) -> 'a array -> 'b array -> bool
public static function exists2 (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Bool;
...
public static function sort (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val stable_sort : ('a -> 'a -> int) -> 'a array -> unit
public static function stable_sort (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val fast_sort : ('a -> 'a -> int) -> 'a array -> unit
public static function fast_sort (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
