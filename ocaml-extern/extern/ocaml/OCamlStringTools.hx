...
public static function make (a0:Int,a1:Dynamic):String;
...
public static function get (a0:String,a1:Int):Dynamic;// Parser val::val concat : string -> string list -> string
...
public static function contains_from (a0:String,a1:Int,a2:Dynamic):Bool;
// Parser val::val rcontains_from : string -> int -> char -> bool
public static function rcontains_from (a0:String,a1:Int,a2:Dynamic):Bool;
// Parser val::val contains : string -> char -> bool
public static function contains (a0:String,a1:Dynamic):Bool;
...
public static function index_from (a0:String,a1:Int,a2:Dynamic):Int;
// Parser val::val index_from_opt : string -> int -> char -> int option
public static function index_from_opt (a0:String,a1:Int,a2:Dynamic):Dynamic;
// Parser val::val rindex_from : string -> int -> char -> int
public static function rindex_from (a0:String,a1:Int,a2:Dynamic):Int;
// Parser val::val rindex_from_opt : string -> int -> char -> int option
public static function rindex_from_opt (a0:String,a1:Int,a2:Dynamic):Dynamic;
// Parser val::val index : string -> char -> int
public static function index (a0:String,a1:Dynamic):Int;
...
public static function rindex (a0:String,a1:Dynamic):Int;
...
public static function set (a0:Dynamic,a1:Int,a2:Dynamic):Void;// Parser val::val blit :  string -> int -> bytes -> int -> int -> unit
...
public static function unsafe_get (a0:String,a1:Int):Dynamic;// Parser external::external unsafe_set : bytes -> int -> char -> unit = "%string_unsafe_set"  [@@ocaml.deprecated]
public static function unsafe_set (a0:Dynamic,a1:Int,a2:Dynamic):Void;// Parser external::external unsafe_blit :  string -> int -> bytes -> int -> int ->    unit = "caml_blit_string" [@@noalloc]
