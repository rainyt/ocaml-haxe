...
public static function make (a0:Dynamic,a1:Dynamic):String;
// Parser val::val init : int -> (int -> char) -> string
public static function init (a0:Dynamic,a1:Dynamic,a2:Dynamic):String;
// Parser external::external length : string -> int = "%string_length"
public static function length (a0:String):Dynamic;// Parser external::external get : string -> int -> char = "%string_safe_get"
public static function get (a0:String,a1:Dynamic):Dynamic;// Parser val::val concat : string -> string list -> string
...
public static function contains_from (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val rcontains_from : string -> int -> char -> bool
public static function rcontains_from (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val contains : string -> char -> bool
public static function contains (a0:String,a1:Dynamic):Dynamic;
// Parser val::val sub : string -> int -> int -> string
public static function sub (a0:String,a1:Dynamic,a2:Dynamic):String;
// Parser val::val split_on_char : char -> string -> string list
public static function split_on_char (a0:Dynamic,a1:String):Array<String>;
...
public static function mapi (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:String):String;
...
public static function iteri (a0:Dynamic,a1:Dynamic,a2:Dynamic,a3:String):Void;
// Parser val::val index_from : string -> int -> char -> int
public static function index_from (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val index_from_opt : string -> int -> char -> int option
public static function index_from_opt (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val rindex_from : string -> int -> char -> int
public static function rindex_from (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val rindex_from_opt : string -> int -> char -> int option
public static function rindex_from_opt (a0:String,a1:Dynamic,a2:Dynamic):Dynamic;
// Parser val::val index : string -> char -> int
public static function index (a0:String,a1:Dynamic):Dynamic;
// Parser val::val index_opt : string -> char -> int option
public static function index_opt (a0:String,a1:Dynamic):Dynamic;
// Parser val::val rindex : string -> char -> int
public static function rindex (a0:String,a1:Dynamic):Dynamic;
// Parser val::val rindex_opt : string -> char -> int option
public static function rindex_opt (a0:String,a1:Dynamic):Dynamic;
...
public static function create (a0:Dynamic):Dynamic;// Parser external::external set : bytes -> int -> char -> unit = "%string_safe_set"  [@@ocaml.deprecated "Use Bytes.set/BytesLabels.set instead."]
public static function set (a0:Dynamic,a1:Dynamic,a2:Dynamic):Void;// Parser val::val blit :  string -> int -> bytes -> int -> int -> unit
public static function blit (a0:String,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Void;
...
public static function unsafe_get (a0:String,a1:Dynamic):Dynamic;// Parser external::external unsafe_set : bytes -> int -> char -> unit = "%string_unsafe_set"  [@@ocaml.deprecated]
public static function unsafe_set (a0:Dynamic,a1:Dynamic,a2:Dynamic):Void;// Parser external::external unsafe_blit :  string -> int -> bytes -> int -> int ->    unit = "caml_blit_string" [@@noalloc]
public static function unsafe_blit (a0:String,a1:Dynamic,a2:Dynamic,a3:Dynamic,a4:Dynamic):Void;}