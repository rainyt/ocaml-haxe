...
extern class Out_channel{}
extern class In_channel{}
enum Fpclass {
FP_normal;
FP_subnormal;
FP_zero;
...
public static function invalid_arg (a0:Dynamic):Dynamic;
// Parser val::val failwith : string -> 'a
public static function failwith (a0:Dynamic):Dynamic;
...
public static function compare (a0:Dynamic,a1:Dynamic):Dynamic;// Parser val::val min : 'a -> 'a -> 'a
...
public static function not (a0:Dynamic):Dynamic;// Parser external::external ( && ) : bool -> bool -> bool = "%sequand"
...
public static var __LOC__ :Dynamic;// Parser external::external __FILE__ : string = "%loc_FILE"
public static var __FILE__ :Dynamic;// Parser external::external __LINE__ : int = "%loc_LINE"
public static var __LINE__ :Dynamic;// Parser external::external __MODULE__ : string = "%loc_MODULE"
public static var __MODULE__ :Dynamic;// Parser external::external __POS__ : string * int * int * int = "%loc_POS"
public static var __POS__ :Dynamic;// Parser external::external __FUNCTION__ : string = "%loc_FUNCTION"
public static var __FUNCTION__ :Dynamic;// Parser external::external __LOC_OF__ : 'a -> string * 'a = "%loc_LOC"
...
public static function succ (a0:Dynamic):Dynamic;// Parser external::external pred : int -> int = "%predint"
public static function pred (a0:Dynamic):Dynamic;// Parser external::external ( + ) : int -> int -> int = "%addint"
...
public static function lnot (a0:Dynamic):Dynamic;
...
public static function sqrt (a0:Dynamic):Dynamic;// Parser external::external exp : float -> float = "caml_exp_float" "exp" [@@unboxed] [@@noalloc]
public static function exp (a0:Dynamic):Dynamic;// Parser external::external log : float -> float = "caml_log_float" "log" [@@unboxed] [@@noalloc]
public static function log (a0:Dynamic):Dynamic;// Parser external::external log10 : float -> float = "caml_log10_float" "log10"  [@@unboxed] [@@noalloc]
public static function log10 (a0:Dynamic):Dynamic;// Parser external::external expm1 : float -> float = "caml_expm1_float" "caml_expm1"  [@@unboxed] [@@noalloc]
public static function expm1 (a0:Dynamic):Dynamic;// Parser external::external log1p : float -> float = "caml_log1p_float" "caml_log1p"  [@@unboxed] [@@noalloc]
public static function log1p (a0:Dynamic):Dynamic;// Parser external::external cos : float -> float = "caml_cos_float" "cos" [@@unboxed] [@@noalloc]
public static function cos (a0:Dynamic):Dynamic;// Parser external::external sin : float -> float = "caml_sin_float" "sin" [@@unboxed] [@@noalloc]
public static function sin (a0:Dynamic):Dynamic;// Parser external::external tan : float -> float = "caml_tan_float" "tan" [@@unboxed] [@@noalloc]
public static function tan (a0:Dynamic):Dynamic;// Parser external::external acos : float -> float = "caml_acos_float" "acos"  [@@unboxed] [@@noalloc]
public static function acos (a0:Dynamic):Dynamic;// Parser external::external asin : float -> float = "caml_asin_float" "asin"  [@@unboxed] [@@noalloc]
public static function asin (a0:Dynamic):Dynamic;// Parser external::external atan : float -> float = "caml_atan_float" "atan"  [@@unboxed] [@@noalloc]
public static function atan (a0:Dynamic):Dynamic;// Parser external::external atan2 : float -> float -> float = "caml_atan2_float" "atan2"  [@@unboxed] [@@noalloc]
public static function atan2 (a0:Dynamic,a1:Dynamic):Dynamic;// Parser external::external hypot : float -> float -> float = "caml_hypot_float" "caml_hypot"  [@@unboxed] [@@noalloc]
public static function hypot (a0:Dynamic,a1:Dynamic):Dynamic;// Parser external::external cosh : float -> float = "caml_cosh_float" "cosh"  [@@unboxed] [@@noalloc]
public static function cosh (a0:Dynamic):Dynamic;// Parser external::external sinh : float -> float = "caml_sinh_float" "sinh"  [@@unboxed] [@@noalloc]
public static function sinh (a0:Dynamic):Dynamic;// Parser external::external tanh : float -> float = "caml_tanh_float" "tanh"  [@@unboxed] [@@noalloc]
public static function tanh (a0:Dynamic):Dynamic;// Parser external::external ceil : float -> float = "caml_ceil_float" "ceil"  [@@unboxed] [@@noalloc]
public static function ceil (a0:Dynamic):Dynamic;// Parser external::external floor : float -> float = "caml_floor_float" "floor"  [@@unboxed] [@@noalloc]
public static function floor (a0:Dynamic):Dynamic;// Parser external::external abs_float : float -> float = "%absfloat"
public static function abs_float (a0:Dynamic):Dynamic;// Parser external::external copysign : float -> float -> float                  = "caml_copysign_float" "caml_copysign"                  [@@unboxed] [@@noalloc]
public static function copysign (a0:Dynamic,a1:Dynamic):Dynamic;// Parser external::external mod_float : float -> float -> float = "caml_fmod_float" "fmod"  [@@unboxed] [@@noalloc]
public static function mod_float (a0:Dynamic,a1:Dynamic):Dynamic;// Parser external::external frexp : float -> float * int = "caml_frexp_float"
public static function frexp (a0:Dynamic):Dynamic;// Parser external::external ldexp : (float [@unboxed]) -> (int [@untagged]) -> (float [@unboxed]) =  "caml_ldexp_float" "caml_ldexp_float_unboxed" [@@noalloc]
...
public static function modf (a0:Dynamic):Dynamic;// Parser external::external float : int -> float = "%floatofint"
public static function float (a0:Dynamic):Dynamic;// Parser external::external float_of_int : int -> float = "%floatofint"
public static function float_of_int (a0:Dynamic):Dynamic;// Parser external::external truncate : float -> int = "%intoffloat"
public static function truncate (a0:Dynamic):Dynamic;// Parser external::external int_of_float : float -> int = "%intoffloat"
public static function int_of_float (a0:Dynamic):Dynamic;// Parser val::val infinity : float
public static var infinity :Dynamic;
// Parser val::val neg_infinity : float
public static var neg_infinity :Dynamic;
// Parser val::val nan : float
public static var nan :Dynamic;
// Parser val::val max_float : float
public static var max_float :Dynamic;
// Parser val::val min_float : float
public static var min_float :Dynamic;
// Parser val::val epsilon_float : float
public static var epsilon_float :Dynamic;
...
public static function classify_float (a0:Dynamic):Fpclass;// Parser val::val ( ^ ) : string -> string -> string
// Parser external::external int_of_char : char -> int = "%identity"
public static function int_of_char (a0:Dynamic):Dynamic;// Parser val::val char_of_int : int -> char
public static function char_of_int (a0:Dynamic):Dynamic;
...
public static function string_of_bool (a0:Dynamic):Dynamic;
// Parser val::val bool_of_string_opt: string -> bool option
public static function bool_of_string_opt(a0:Dynamic):Dynamic;
// Parser val::val bool_of_string : string -> bool
public static function bool_of_string (a0:Dynamic):Dynamic;
// Parser val::val string_of_int : int -> string
public static function string_of_int (a0:Dynamic):Dynamic;
// Parser val::val int_of_string_opt: string -> int option
public static function int_of_string_opt(a0:Dynamic):Dynamic;
// Parser external::external int_of_string : string -> int = "caml_int_of_string"
public static function int_of_string (a0:Dynamic):Dynamic;// Parser val::val string_of_float : float -> string
public static function string_of_float (a0:Dynamic):Dynamic;
// Parser val::val float_of_string_opt: string -> float option
public static function float_of_string_opt(a0:Dynamic):Dynamic;
// Parser external::external float_of_string : string -> float = "caml_float_of_string"
public static function float_of_string (a0:Dynamic):Dynamic;// Parser external::external fst : 'a * 'b -> 'a = "%field0"
...
public static var stdin :In_channel;
// Parser val::val stdout : out_channel
public static var stdout :Out_channel;
// Parser val::val stderr : out_channel
public static var stderr :Out_channel;
...
public static function print_string (a0:Dynamic):Void;
// Parser val::val print_bytes : bytes -> unit
public static function print_bytes (a0:Dynamic):Void;
// Parser val::val print_int : int -> unit
public static function print_int (a0:Dynamic):Void;
// Parser val::val print_float : float -> unit
public static function print_float (a0:Dynamic):Void;
// Parser val::val print_endline : string -> unit
public static function print_endline (a0:Dynamic):Void;
...
public static function prerr_string (a0:Dynamic):Void;
// Parser val::val prerr_bytes : bytes -> unit
public static function prerr_bytes (a0:Dynamic):Void;
// Parser val::val prerr_int : int -> unit
public static function prerr_int (a0:Dynamic):Void;
// Parser val::val prerr_float : float -> unit
public static function prerr_float (a0:Dynamic):Void;
// Parser val::val prerr_endline : string -> unit
public static function prerr_endline (a0:Dynamic):Void;
...
public static function read_line (a0:Void):Dynamic;
...
public static function read_int (a0:Void):Dynamic;
...
public static function read_float (a0:Void):Dynamic;
...
public static function open_out (a0:Dynamic):Out_channel;
// Parser val::val open_out_bin : string -> out_channel
public static function open_out_bin (a0:Dynamic):Out_channel;
// Parser val::val open_out_gen : open_flag list -> int -> string -> out_channel
public static function open_out_gen (a0:Array<Open_flag>,a1:Dynamic,a2:Dynamic):Out_channel;
// Parser val::val flush : out_channel -> unit
public static function flush (a0:Out_channel):Void;
...
public static function output_char (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val output_string : out_channel -> string -> unit
public static function output_string (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val output_bytes : out_channel -> bytes -> unit
public static function output_bytes (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val output : out_channel -> bytes -> int -> int -> unit
public static function output (a0:Out_channel,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val output_substring : out_channel -> string -> int -> int -> unit
public static function output_substring (a0:Out_channel,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val output_byte : out_channel -> int -> unit
public static function output_byte (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val output_binary_int : out_channel -> int -> unit
public static function output_binary_int (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val output_value : out_channel -> 'a -> unit
public static function output_value (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val seek_out : out_channel -> int -> unit
public static function seek_out (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val pos_out : out_channel -> int
public static function pos_out (a0:Out_channel):Dynamic;
// Parser val::val out_channel_length : out_channel -> int
public static function out_channel_length (a0:Out_channel):Dynamic;
// Parser val::val close_out : out_channel -> unit
public static function close_out (a0:Out_channel):Void;
// Parser val::val close_out_noerr : out_channel -> unit
public static function close_out_noerr (a0:Out_channel):Void;
// Parser val::val set_binary_mode_out : out_channel -> bool -> unit
public static function set_binary_mode_out (a0:Out_channel,a1:Dynamic):Void;
// Parser val::val open_in : string -> in_channel
public static function open_in (a0:Dynamic):In_channel;
// Parser val::val open_in_bin : string -> in_channel
public static function open_in_bin (a0:Dynamic):In_channel;
// Parser val::val open_in_gen : open_flag list -> int -> string -> in_channel
public static function open_in_gen (a0:Array<Open_flag>,a1:Dynamic,a2:Dynamic):In_channel;
// Parser val::val input_char : in_channel -> char
public static function input_char (a0:In_channel):Dynamic;
// Parser val::val input_line : in_channel -> string
public static function input_line (a0:In_channel):Dynamic;
// Parser val::val input : in_channel -> bytes -> int -> int -> int
public static function input (a0:In_channel,a1:Dynamic,a2:Dynamic,a3:Dynamic):Dynamic;
// Parser val::val really_input : in_channel -> bytes -> int -> int -> unit
public static function really_input (a0:In_channel,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
// Parser val::val really_input_string : in_channel -> int -> string
public static function really_input_string (a0:In_channel,a1:Dynamic):Dynamic;
// Parser val::val input_byte : in_channel -> int
public static function input_byte (a0:In_channel):Dynamic;
// Parser val::val input_binary_int : in_channel -> int
public static function input_binary_int (a0:In_channel):Dynamic;
// Parser val::val input_value : in_channel -> 'a
public static function input_value (a0:In_channel):Dynamic;
// Parser val::val seek_in : in_channel -> int -> unit
public static function seek_in (a0:In_channel,a1:Dynamic):Void;
// Parser val::val pos_in : in_channel -> int
public static function pos_in (a0:In_channel):Dynamic;
// Parser val::val in_channel_length : in_channel -> int
public static function in_channel_length (a0:In_channel):Dynamic;
// Parser val::val close_in : in_channel -> unit
public static function close_in (a0:In_channel):Void;
// Parser val::val close_in_noerr : in_channel -> unit
public static function close_in_noerr (a0:In_channel):Void;
// Parser val::val set_binary_mode_in : in_channel -> bool -> unit
public static function set_binary_mode_in (a0:In_channel,a1:Dynamic):Void;
...
public static function string_of_format (a0:Dynamic):Dynamic;
...
public static function exit (a0:Dynamic):Dynamic;
...
public static function valid_float_lexem (a0:Dynamic):Dynamic;
// Parser val::val unsafe_really_input : in_channel -> bytes -> int -> int -> unit
public static function unsafe_really_input (a0:In_channel,a1:Dynamic,a2:Dynamic,a3:Dynamic):Void;
