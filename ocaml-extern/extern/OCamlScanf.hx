typedef Scanf_SCANNING  = Dynamic;

typedef Scanf_Scanbuf  = Dynamic;

typedef Scanf_File_name  = String;

typedef Scanf_Integer_conversion  = Dynamic;
...
public static function memo_from_channel(a0:Dynamic):Dynamic;
...
public static function skip_whites(a0:Dynamic):Void;
public static function check_char(a0:Dynamic,a1:OCamlChar):Void;
public static function check_this_char(a0:Dynamic,a1:OCamlChar):Void;
public static function check_newline(a0:Dynamic):Void;
public static function token_char(a0:Dynamic):OCamlChar;
public static function token_string(a0:Dynamic):String;
public static function token_bool(a0:Dynamic):Bool;
public static function integer_conversion_of_char(a0:OCamlChar):Dynamic;
public static function token_int_literal(a0:Dynamic,a1:Dynamic):String;
public static function token_int(a0:Dynamic,a1:Dynamic):Int;
public static function token_float(a0:Dynamic):Float;
...
public static function token_nativeint(a0:Dynamic,a1:Dynamic):Dynamic;
public static function token_int32(a0:Dynamic,a1:Dynamic):Dynamic;
public static function token_int64(a0:Dynamic,a1:Dynamic):Dynamic;
public static function scan_decimal_digit_star(a0:Int,a1:Dynamic):Int;
public static function scan_decimal_digit_plus(a0:Int,a1:Dynamic):Int;
public static function scan_digit_star(a0:OCamlChar->Bool,a1:Int,a2:Dynamic):Int;
public static var scan_digit_plus:Dynamic;
public static function is_binary_digit(a0:OCamlChar):Bool;
public static function scan_binary_int(a0:Int,a1:Dynamic):Int;
public static function is_octal_digit(a0:OCamlChar):Bool;
public static function scan_octal_int(a0:Int,a1:Dynamic):Int;
public static function is_hexa_digit(a0:OCamlChar):Bool;
public static function scan_hexadecimal_int(a0:Int,a1:Dynamic):Int;
public static function scan_unsigned_decimal_int(a0:Int,a1:Dynamic):Int;
public static function scan_sign(a0:Int,a1:Dynamic):Int;
public static function scan_optionally_signed_decimal_int(a0:Int,a1:Dynamic):Int;
public static function scan_unsigned_int(a0:Int,a1:Dynamic):Int;
public static function scan_optionally_signed_int(a0:Int,a1:Dynamic):Int;
public static var scan_int_conversion:Dynamic;
public static function scan_fractional_part(a0:Int,a1:Dynamic):Int;
public static function scan_exponent_part(a0:Int,a1:Dynamic):Int;
public static function scan_integer_part(a0:Int,a1:Dynamic):Int;
public static function scan_float(a0:Int,a1:Int,a2:Dynamic):Dynamic;
public static var check_case_insensitive_string:Dynamic;
public static function scan_hex_float(a0:Int,a1:Int,a2:Dynamic):Int;
public static function scan_caml_float_rest(a0:Int,a1:Int,a2:Dynamic):Int;
public static function scan_caml_float(a0:Int,a1:Int,a2:Dynamic):Int;
public static function scan_string(a0:Dynamic,a1:Int,a2:Dynamic):Int;
public static function scan_char(a0:Int,a1:Dynamic):Int;
...
public static function check_next_char(a0:String,a1:Int,a2:Dynamic):OCamlChar;
public static function check_next_char_for_char(a0:Int,a1:Dynamic):OCamlChar;
public static function check_next_char_for_string(a0:Int,a1:Dynamic):OCamlChar;
public static function scan_backslash_char(a0:Int,a1:Dynamic):Int;
public static function scan_caml_char(a0:Int,a1:Dynamic):Int;
public static function scan_caml_string(a0:Int,a1:Dynamic):Int;
public static function scan_bool(a0:Dynamic):Int;
public static var scan_chars_in_char_set:Dynamic;
public static function scanf_bad_input(a0:Dynamic,a1:Dynamic):Dynamic;
public static function get_counter(a0:Dynamic,a1:Dynamic):Int;
