...
public static function unsafe_sub(a0:Dynamic,a1:Int,a2:Int):Dynamic;
public static function append_prim(a0:Dynamic,a1:Dynamic):Dynamic;
...
public static function create(a0:Int):OCamlArray<Float>;
public static function length(a0:OCamlArray<Float>):Int;
public static function get(a0:OCamlArray<Float>,a1:Int):Float;
public static function set(a0:OCamlArray<Float>,a1:Int,a2:Float):Void;
public static function unsafe_get(a0:OCamlArray<Float>,a1:Int):Float;
public static function unsafe_set(a0:OCamlArray<Float>,a1:Int,a2:Float):Void;
...
public static function list_length(a0:Int,a1:Dynamic):Int;
